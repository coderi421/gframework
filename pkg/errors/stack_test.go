...
func TestFrameFormat(t *testing.T) {
	var tests = []struct {
		...
		initpc,
		"%+s",
		"github.com/CoderI421/gmicro/pkg/errors.init\n" +
...
func TestFuncname(t *testing.T) {
	tests := []struct {
		...
		{"", ""},
		{"runtime.main", "main"},
		{"github.com/CoderI421/gmicro/pkg/errors.funcname", "funcname"},
		{"funcname", "funcname"},
...
func TestStackTrace(t *testing.T) {
	tests := []struct {
		...
		New("ooh"), []string{
			"github.com/CoderI421/gmicro/pkg/errors.TestStackTrace\n" +
		...
		func() error { return New("ooh") }(), []string{
			`github.com/CoderI421/gmicro/pkg/errors.TestStackTrace.func1` +
		...
		Cause(func() error {
			...
			`github.com/CoderI421/gmicro/pkg/errors.TestStackTrace.func2.1` +
				"\n\t.+/gmicro/pkg/errors/stack_test.go:145", // this is the stack of Errorf
			`github.com/CoderI421/gmicro/pkg/errors.TestStackTrace.func2` +
...
func TestStackTraceFormat(t *testing.T) {
	tests := []struct {
		...
		"%+v",
		"\n" +
			"github.com/CoderI421/gmicro/pkg/errors.stackTrace\n" +
			"\t.+/gmicro/pkg/errors/stack_test.go:174\n" +
			"github.com/CoderI421/gmicro/pkg/errors.TestStackTraceFormat\n" +
